...
export async function run(root){
  ...
  root.innerHTML=`<style>${calculatorCss}</style><div class="calc-page" style="--calc-accent:#E0A800;--calc-accent-dark:#B98500"><div class="calc-heading"><h2>RBS Converter</h2><p>Convert glucose units.</p></div><div class="calc-stack">
