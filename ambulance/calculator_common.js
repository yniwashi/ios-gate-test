...
export const calculatorCss = `
  .calc-page{--calc-accent:#2563eb;max-width:620px;margin:0 auto;padding:20px 18px 30px;color:var(--text)}
  ...
  .calc-card h3{margin:0;color:var(--calc-accent);font-size:17px;font-weight:900}
  ...
  .calc-input-wrap:focus-within{border-color:var(--calc-accent);box-shadow:0 0 0 3px color-mix(in srgb,var(--calc-accent) 18%,transparent)}
  ...
  .calc-suffix{flex:none;padding-right:10px;color:var(--calc-accent);font-size:13px;font-weight:900}
  ...
  .calc-segment button.active{background:var(--calc-accent);color:#fff}
  .calc-button{min-height:46px;border:0;border-radius:14px;background:var(--calc-accent);color:#fff;font-size:17px;font-weight:900}
  .calc-result{display:grid;gap:9px;padding:16px;border:1px solid var(--border);border-radius:8px;background:var(--surface)}
  .calc-result h3{margin:0;color:var(--calc-accent);font-size:18px}.calc-result-main{color:#0d7d3b;font-size:30px;line-height:1.15;font-weight:950}
